...
obj += '<div class="under"> <div class="imager "><img src="'+hostname+'img/jeshoots-com-219388-unsplash.jpg" height="100%" width="100%"></div><div class="righyww"><h4 class="text-uppercase"><a class="'+ie+'list" href="'+hostname+'interLoad?exm='+ie+'&id=5i4J8eryvYr86jo9r8hDsew83iy3kQZJHDNgMrwPouAnfyfro&name='+myObj[ie].name+'" title="Begin Exam" style=" ">'+myObj[ie].name+'</a></h4><h1 class="small ">'+myObj[ie].upper_time+'</h1><div class="floow" style="right: 0; margin-top: 0px;"></div></div></div>';
   }
  $(".tyi").html(obj);
 $(".linker").each( function(){
$(this).addClass("first-make-fakes");
 });

  $(".first-make-fakes").each( function(){
